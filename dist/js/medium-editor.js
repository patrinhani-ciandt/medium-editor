    ...
    var Toolbar = MediumEditor.Extension.extend({
        ...
        positionToolbar: function (selection) {
            ...
            var elementsContainer = this.getEditorOption('elementsContainer') || this.document.body,
                ...
                selectionBoundaryLeft = (selectionBoundary) ? selectionBoundary.left : 0,
                selectionBoundaryRight = (selectionBoundary) ? selectionBoundary.right : 0,
                middleSelectionBoundary = ((selectionBoundaryLeft - elementsContainerLeftValue) + (selectionBoundaryRight - elementsContainerLeftValue)) / 2,
                toolbarHeight = toolbarElement.offsetHeight,
                toolbarWidth = toolbarElement.offsetWidth,
                halfOffsetWidth = toolbarWidth / 2,
